### SOFLang - Scarcely Object-oriented or Functional Language
...
- [PeanutPreprocessor](soflang/preprocess.py) - a resolver of imports and templates.
...
- [LionVM](soflang/lvm.py) - a simple runner for assembler.
- [Bearboard](arch/components.py) - a simulation of several computer components.
- [Foxbugger](soflang/debugger.py) - interactive debugger for assembler, displaying source code and variables
